...
import FileAttachmentList from "../../src/FileAttachmentList";
...
const feature = loadFeature(
  "./__tests__/features/FileAttachmentList-scenario.feature",
);
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to FileAttachmentList", ({ given, when, then }) => {
    ...
    then("FileAttachmentList will load with out errors", () => {
      ...
      component
        .findWhere((node) => node.prop("testID") === "navTo")
        .simulate("press");
