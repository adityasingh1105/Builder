...
import Print from "../../src/Print.web";
...
const feature = loadFeature(
  "./__tests__/features/Print-scenario.web.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to Print", ({ given, when, then }) => {
    ...
    then("I can select the button with with out errors", () => {
      // let buttonComponent = printBlock.findWhere(
      //   (node) => node.prop("data-test-id") === "btnPrint"
      // );
